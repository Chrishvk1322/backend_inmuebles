...
from inmuebleslist_app.api.views import EdificacionAV, EdificacionDetalleAV, EmpresaAV, EmpresaDetalleAV, ComentarioList, ComentarioDetail, ComentarioCreate, EmpresaVS,  UsuarioComentario, EdificacionList
